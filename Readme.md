...
<div align="center">
  ...
  <a href="mailto:ivanbayigabogmis0@gmail.com">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 190 28" style="height: 24px; vertical-align: middle; margin-left: 10px;">
      ...
      <text x="28" y="18" font-family="Arial, sans-serif" font-size="12" font-weight="bold" fill="#ffffff">Available for work</text>
    </svg>
  </a>
</div>
    ...
    <tr>
      <td width="50%" valign="top">
        ...
        <ul>
          ...
          <li>Cloud, DevOps & CI/CD</li>
          <li>Cybersecurity & Secure-by-Design</li>
        </ul>
      </td>
      <td width="50%" valign="top">
...
<div align="center">
  <table>
    <tr>
      <td width="100%">
        <h3>🌍 MONDOS (MONDO OS) — Enterprise Operating System</h3>
        <p><i>A next-generation, cloud-native Enterprise OS with total modularity and zero-trust security.</i></p>
        <ul>
          <li><b>12 Innovations:</b> Adaptive UI, Self-healing Runtime, Capability Engine, Digital Twin, Knowledge Graph, Event Mesh</li>
          <li><b>Stack:</b> Java 21, Go 1.22, Python 3.12, C++ 20, React/Next.js</li>
          <li><b>Data:</b> PostgreSQL 16 (RLS), Redis 7, Kafka, Elasticsearch, ClickHouse</li>
          <li><b>Architecture:</b> Hexagonal/DDD, Multi-tenant, Cloud Native (K8s/GitOps)</li>
        </ul>
      </td>
    </tr>
    <tr><td><br/></td></tr>
    <tr>
      <td width="100%">
        <h3>🏥 GinDHO — Hospital Information System</h3>
        <p>Modular healthcare platform for modern medical environments.</p>
        <p><b>Stack:</b> Java • Spring Boot • FastAPI • React • Kubernetes • PostgreSQL • MongoDB</p>
        <p><b>Standards:</b> FHIR • HL7 • DICOM</p>
      </td>
    </tr>
    <tr><td><br/></td></tr>
    <tr>
    ...
    <tr>
      <td width="100%">
        <h3>🛒 BayGod Trade — Digital Commerce Platform</h3>
        <p>Modular marketplace with secure escrow transactions.</p>
        <p><b>Stack:</b> Django • Next.js • Flutter • PostgreSQL • Redis</p>
      </td>
    </tr>
  </table>
</div>
...
<p align="center">
  ...
  Let's build something useful and scalable together.
</p>
